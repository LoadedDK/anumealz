	                ...
	                switch($flagday) {
	                        case 2:
	                                ...
	                                if(isset($data['content'])) {?>
	                                        오늘 점심<span class="content_date_small">(11:40~13:30)</span>
	                                        </div>
						...
						<? switch($data['type']) {
	                                        ...
	                                        <span class="content_date_small">(11:40~13:30)</span>
	                                        </div>
	                                        <div class="content_menu"><?echo $data['content'];?></div>
	                                        <?break;
	                                }
	                        default:
	                                echo "오늘, 내일 데이터가 없음<br/>";
	                }?>
		...
		<div class="content_location_b">
	                ...
	                switch($flagday) {
	                        ...
	                        case 2:
	                                ...
	                                $data = mysql_fetch_array($result);
	                                if(isset($data['content'])) {?>
	                                        오늘 점심<span class="content_date_small">(12:00~13:30)</span>
	                                        </div>
	                                        <div class="content_menu"><?echo $data['content'];?></div>
	                                        <?break;
	                                }
	                        ...
	                        case 4:
	                                ...
	                                if(isset($data['content'])) {?>
	                                        ...
	                                        <span class="content_date_small">(07:30~09:00)</span>
	                                        </div>
	                                        <div class="content_menu"><?echo $data['content'];?></div>
	                                        <?break;
	                                }
